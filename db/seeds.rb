...
exuma = Island.create(name: "Exuma", location: "Bahamas", description: "Crystal blue waters and white sand beaches make Exuma the perfect Island getaway", user: owen, price: "£995.50", latitude: 23.6193, longitude: 75.9695)
...
galapagos = Island.create(name: "Galapagos", location: "Pacific Ocean", description: "Discover amazing wildlife in an incredible setting off the coast of Ecuador", user: zoe, price: "£1995.50", latitude: 0.9538, longitude: 90.9656)
...
maldives = Island.create(name: "Maldives", location: "Indian Ocean", description: "White sand beaches and cocktails", user: joe, price: "£795.50", latitude: 3.2028, longitude: 73.2207)
